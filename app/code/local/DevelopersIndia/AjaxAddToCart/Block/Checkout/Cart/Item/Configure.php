 ...
 * @module     Checkout
 */
class DevelopersIndia_AjaxAddToCart_Block_Checkout_Cart_Item_Configure extends Mage_Core_Block_Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($block) {
            $block->setTemplate('ajaxaddtocart/checkout/cart/item/configure/updatecart.phtml');
        }
