                 ...
                 */
                    ...
                    foreach ($subscriptionData as $item) {
                        ...
                        if ($item['subscriber_email'] == $email) {
                            $session->addError($this->__('You are been already subscribed to') . ' ' . $this->__($urlCollection[$city]) . '. ' . $this->__('Sign-in to edit your subscription.'));
                            $flag = 1;
                        }
                    }
...
//                }
    ...
    public function confirmAction()
    {
        ...
        $resultproductids = $currentdeal->fetchAll("Select subscriber_confirm_code from " . $tprefix . "newsletter_subscriber
