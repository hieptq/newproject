        ...
        if ($this->getFilter('deal_name') != '') {
            ...
            if ($roleId == 1) {
                $select = $read->select()
                                ...
                                ->join(array('pei' => $couponTable), 'pei.order_id=cp.entity_id', array('ordercustomer_id', 'uniqueid', 'customer_name', 'product_name', 'quantity', 'quantitynumber', 'created_time', 'couponstatus', 'updated_on','vouchercode'))
           ...
           // print_r($coupon_list); die;
            ...
            $vouchercode = $coupon_list[0][vouchercode];
